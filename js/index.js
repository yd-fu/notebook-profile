...
vara[0] = new Vara(
  ...
  [
    ...
    {
      text: "..... also like hiking, indie-rock, fashion",
      id: "end",
      color: "#3f51b5",
      delay: 1000,
      x: posX,
...
vara[1] = new Vara(
  ...
  [
    ...
    {
      text: "I steal this from somewhere",
      y: 40,
      x: posX,
      duration: 4000
    },
    {
      text: "too lazy to build from scratch",
      y: 40,
      x: posX,
      duration: 3500
    }
...
vara[2] = new Vara(
  ...
  [
    ...
    {
      text: "Okay, i will stop now",
      y: 40,
      x: posX,
      duration: 4000
    },
    {
      text: "go home and play some mario kart🚙",
      y: 20,
      x: posX,
      duration: 3500
    },
